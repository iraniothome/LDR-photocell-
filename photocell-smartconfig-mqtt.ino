...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (strcmp(topic, (String("home/photocellrelay")+clientid).c_str()) == 0){
    ...
    switchState1 = !switchState1; 
      ...
      Serial.println(String("home/photocellrelay")+clientid+String("ON"));

      client.publish((String("home/photocellrelay")+clientid+String("/status")).c_str(), "ON");
    ...
    switchState1 = !switchState1; 
      ...
      Serial.println(String("home/photocellrelay")+clientid+String("OFF"));

      client.publish((String("home/photocellrelay")+clientid+String("/status")).c_str(), "OFF");
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(username, username, password, willTopic, 0, 1, (String("I'm dead: ")+username).c_str())) {     // username as client ID
      ...
      client.publish("all", (String("home/photocellrelay")+clientid).c_str());

      // ... and resubscribe

      client.subscribe((String("home/photocellrelay")+clientid).c_str());
...
int reading = digitalRead(buttonPin1);
  ...
  if (reading != lastButtonState1) {
    if (reading == LOW)
    {
      ...
      Serial.println(String("home/photocellrelay")+clientid+String(" : ")+String(switchState1));
      client.publish((String("home/photocellrelay")+clientid+String("/status")).c_str(),String(switchState1).c_str());
...
int photocellReading = digitalRead(photocellPin);
   if(photocellReading != lastphotocellState){
      ...
      lastphotocellState = photocellReading;
   }
